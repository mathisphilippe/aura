<script lang="ts">
  ...
  // Gestion de la souscription aux notifications Web Push
  ...
  async function handleTogglePush() {
    if (!('serviceWorker' in navigator) || !('PushManager' in window)) {
      alert("Les notifications ne sont pas supportées sur ce navigateur (ajoute l'app à l'écran d'accueil sur iOS).");
      return;
    }
